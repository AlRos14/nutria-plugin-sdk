...
Developer reference for SDK `0.5.0` and manifest schema `5.0`.

| Document | Purpose |
|---|---|
| [quickstart.md](quickstart.md) | Build a strict schema 5.0 plugin |
...
settings, specs, and declarative admin assets. Its schema 5.0 manifest must also
